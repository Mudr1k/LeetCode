...
public class Solution {
    ...
    public static void main(String[] args) {
        System.out.println(IpFactory.getIp("192.168.1.1").check());
        System.out.println(IpFactory.getIp("2001:0db8:85a3:0000:0000:8a2e:0370:7334").check());
        System.out.println(IpFactory.getIp("02001:0db8:85a3:0000:0000:8a2e:0370:7334").check());
        System.out.println(IpFactory.getIp("192.168.1.01").check());
        System.out.println(IpFactory.getIp("192.168.1.z1").check());
        System.out.println(IpFactory.getIp("192.168.1.1.").check());
        System.out.println(IpFactory.getIp(".192.168.1.1").check());
